...
{% endif %}
      ...
      <p class="post-tags">
        <a href="{{ year | prepend: '/AI/' | prepend: site.baseurl}}">
          <i class="fa-solid fa-calendar fa-sm"></i> {{ year }} </a>

          {% if tags != "" %}
          &nbsp; &middot; &nbsp;
            {% for tag in post.tags %}
            <a href="{{ tag | slugify | prepend: '/AI/tag/' | prepend: site.baseurl}}">
          ...
          &nbsp; &middot; &nbsp;
            ...
            <a href="{{ category | slugify | prepend: '/AI/category/' | prepend: site.baseurl}}">
