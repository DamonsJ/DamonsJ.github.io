...
_When $$ a \ne 0 $$, there are two solutions to $$ ax^2 + bx + c = 0 $$_

is written by enclosing a Mathjax expression within _a matching pair of double dollar signs: `$$`_:
